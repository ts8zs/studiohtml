import{_ as n,p as a,q as i,Q as t,R as e,t as o}from"./framework-5866ffd3.js";const m={},d=e("ul",null,[e("li",null,[o("沙盒导图 "),t(" 本地调试用这个 "),e("ul",null,[e("li",null,[e("a",{href:"Api/Class/SandboxSummary.html"},"SandboxNode Summary")])]),t(" 线上部署用这个 "),t(' - <a href="Api/Class/SandboxSummary_git.html">SandboxNode Summary</a>     ')])],-1);function l(s,p){return a(),i("div",null,[t(" 侧边栏 studiodocs/_sidebar.md "),d,t(` 	
...
- 类
	...
	- 3.Game Play
		...
		- [Players](/Api/Class/GamePlay/SandBoxPlayersRoot.md)
	...
	- 9.角色
		...
		- [ClientActor](/Api/Class/Role/ClientActor.md)
		- [ClientMob](/Api/Class/Role/ClientMob.md)
	- 10.玩家输入
	...
	- 12.数据
		- [FriendsService](/Api/Class/Service/SandboxFriendsService.md)
		- [NetService](/Api/Class/Service/SandboxNetService.md)
		- [CloudService](/Api/Class/Service/CloudService.md)
	- 13.服务
...
- 枚举
	...
	- 3.UI
		...
		- [DownEffect](/Api/Enumerate/UI/ButtonDownEffect.md)
		...
		- [ScaleType](/Api/Enumerate/UI/ScaleType.md)
	...
	- 4.Game Play
		...
		- [CameraModel](/Api/Enumerate/GamePlay/CameraModel.md)
		- [CameraType](/Api/Enumerate/GamePlay/CameraType.md)
	...
	- 6.角色
		- [BehaviorState](/Api/Enumerate/Role/BehaviorState.md)
		- [DimensionUnit](/Api/Enumerate/Role/DimensionUnit.md)
		- [TextureBlend](/Api/Enumerate/Role/TextureBlend.md)
...
- 无分类
	...
	- [Script](/Api/Class/NoType/ScriptNode.md) `),t(" 以下略 ")])}const A=n(m,[["render",l],["__file","sidebar.html.vue"]]);export{A as default};
