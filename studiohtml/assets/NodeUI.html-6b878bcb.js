...
挑战
至少还有一种其他设置组合将产生上面相同的 GUI 对象，您能想到吗？这里有一个提示：将锚点设置为 TextLabel 对象的中心，然后根据需要调整 Scale 和 Offset 值。 `)])}const g=n(f,[["render",b],["__file","NodeUI.html.vue"]]);export{g as default};
